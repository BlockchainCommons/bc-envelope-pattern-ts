...
`@blockchaincommons/envelope-pattern` depends on `@blockchaincommons/components`, `@blockchaincommons/dcbor-compat`, `@blockchaincommons/dcbor-parse`, `@blockchaincommons/dcbor-pattern`, `@blockchaincommons/envelope`, `@blockchaincommons/known-values`, `@blockchaincommons/rand` at runtime.
