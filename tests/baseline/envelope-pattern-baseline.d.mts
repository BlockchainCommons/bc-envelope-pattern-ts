import {
  ArrayPattern as ArrayPattern$1,
  BoolPattern as BoolPattern$1,
  ByteStringPattern as ByteStringPattern$1,
  DatePattern as DatePattern$1,
  Interval,
  Interval as Interval$1,
  KnownValuePattern as KnownValuePattern$1,
  NullPattern as NullPattern$1,
  NumberPattern as NumberPattern$1,
  Pattern as Pattern$1,
  Quantifier,
  Quantifier as Quantifier$1,
  Reluctance,
  Reluctance as Reluctance$1,
  TaggedPattern as TaggedPattern$1,
  TextPattern as TextPattern$1,
 ...
 */
declare function formatPathsWithCapturesOpt(
  paths: Path[],
 ...
 */
declare function registerVMPatternFunctions(
 ...
 */
declare function compileAsAtomic(
  pat: Pattern,
  code: Instr[],
  literals: Pattern[],
  _captures: string[],
 ...
 */
declare function registerPatternMatchFn(
 ...
 */
declare function dispatchPathsWithCaptures(
  pattern: Pattern,
  haystack: Envelope,
 ...
 */
declare function dispatchCompile(
  pattern: Pattern,
  code: Instr[],
  literals: Pattern[],
  captures: string[],
...
declare function registerByteStringPatternFactory(
...
declare function registerKnownValuePatternFactory(
 ...
 */
declare function leafPatternPathsWithCaptures(
  pattern: LeafPattern,
  haystack: Envelope,
): [Path[], Map<string, Path[]>];
/**
 ...
 */
declare function leafPatternCompile(
  pattern: LeafPattern,
  code: Instr[],
  literals: Pattern[],
  captures: string[],
...
declare function registerLeafStructurePatternFactory(
...
declare function registerPredicatePatternFactory(
...
declare function registerAssertionsPatternFactory(
...
declare function registerObscuredPatternFactory(
 ...
 */
declare function structurePatternPathsWithCaptures(
 ...
 */
declare function structurePatternCompile(
  pattern: StructurePattern,
  code: Instr[],
  literals: Pattern[],
  captures: string[],
...
declare function registerTraversePatternFactory(
 ...
 */
declare function metaPatternPathsWithCaptures(
  pattern: MetaPattern,
  haystack: Envelope,
): [Path[], Map<string, Path[]>];
/**
 ...
 */
declare function metaPatternCompile(
  pattern: MetaPattern,
  code: Instr[],
  literals: Pattern[],
  captures: string[],
 ...
 */
declare function patternPathsWithCaptures(
  pattern: Pattern,
  haystack: Envelope,
): [Path[], Map<string, Path[]>];
/**
 ...
 */
declare function patternCompile(
  pattern: Pattern,
  code: Instr[],
  literals: Pattern[],
  captures: string[],
