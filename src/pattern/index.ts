 ...
 *
 *
 * @blockchaincommons/envelope-pattern - Pattern module
 *
...
import type { Envelope, Digest } from "@blockchaincommons/envelope";
import type { CborInput, CborDate, Tag } from "@blockchaincommons/dcbor-compat";
import type { KnownValue } from "@blockchaincommons/known-values";
import { UNIT as KNOWN_VALUE_UNIT } from "@blockchaincommons/known-values";
import {
...
import { type Pattern as DCBORPatternRegister } from "@blockchaincommons/dcbor-pattern";
